"""Helpers used to turn plot commands into CyberPi Python and mBlock export files."""
...
from src.bridge_protocol import BridgeCommand
...
def write_script_outputs(
    ...
    """Write the exported Python file and, when requested, the .mcode archive."""
