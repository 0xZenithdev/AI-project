"""
Run repeatable AI-style experiments across perception and planning variants.
        ...
        for comparison in summary["planning_comparisons"]:
            lines.extend(
                [
                    ...
                    f"({comparison['pen_up_improvement_pct']}%)",
                ]
            )
        lines.append("")
        ...
        for comparison in summary["vision_comparisons"]:
            lines.extend(
                [
                    ...
                    f"commands delta = {comparison['num_commands_delta']}",
                ]
            )
        lines.append("")
