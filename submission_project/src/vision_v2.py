"""Turn an input image into drawable paths."""
...
def preprocess_foreground_mask(
    ...
    """
    Build a normalized dark-foreground mask.

    This keeps the classical pipeline explainable:
    normalize lighting, threshold dark foreground, then clean the mask.
    """
...
def get_drawing_paths_ml(
    ...
    """
    ML path extraction: image -> predicted line mask -> drawable paths.
